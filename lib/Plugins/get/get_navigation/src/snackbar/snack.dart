...
class GetBar<T extends Object> extends StatefulWidget {
  ...
  /// Check (this example)[https://github.com/flutter/flutter/blob/master/packages/flutter/src/material/shadows.dart]
  ...
  List<Widget> _getAppropriateRowLayout() {
    ...
    if (widget.icon == null && widget.mainButton == null) {
          ...
          child: Column(
            ...
            children: <Widget>[
              Row(
                ...
                children: [
                  (_isTitlePresent) ? _getTitleText() : _emptyWidget,
                  if (widget.hasUndo)
                    Text(
                      "Undo",
                      style: TextStyle(
      ...
      return <Widget>[
        ...
        Expanded(
          flex: 1,
          child: (_isTitlePresent) ? _getTitleText() : _emptyWidget,
        ),
        if (widget.hasUndo) ...[
          SizedBox(
            width: 8.0,
