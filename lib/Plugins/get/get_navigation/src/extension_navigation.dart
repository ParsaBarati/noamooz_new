    ...
    final getBar = GetBar(
        ...
        titleText: titleText ??
            AutoSizeText(
              ...
              style: TextStyle(
                fontFamily: "iranSans",
                color: colorText ?? iconColor ?? ColorUtils.black,
...
extension ExtensionDialog on GetInterface {
  ...
  Future<T?> dialog<T>(
    ...
    return generalDialog<T>(
      ...
      barrierColor: barrierColor ?? Colors.black.withOpacity(0.1),
        ...
        actions.add(TextButton(
          style: TextButton.styleFrom(
            ...
            shape: RoundedRectangleBorder(
                side: BorderSide(
                    color: buttonColor ?? theme.secondaryHeaderColor,
                    width: 2,
          ...
          child: Text(
            textCancel ?? "Cancel",
            style: TextStyle(color: cancelTextColor ?? theme.secondaryHeaderColor),
          ),
        ));
      }
    }
    if (confirm != null) {
      ...
      if (leanConfirm) {
        actions.add(TextButton(
            style: TextButton.styleFrom(
              tapTargetSize: MaterialTapTargetSize.shrinkWrap,
              backgroundColor: buttonColor ?? theme.secondaryHeaderColor,
              shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(100)),
            ),
            child: Text(
              textConfirm ?? "Ok",
              style:
                  TextStyle(color: confirmTextColor ?? theme.scaffoldBackgroundColor),
            ),
            onPressed: () {
              onConfirm?.call();
            }));
