...
import 'package:noamooz/Plugins/tooltip/just_the_tooltip.dart';
import 'package:noamooz/Utils/color_utils.dart';
import 'models/target_information.dart';
import 'positioned_tooltip.dart';
...
abstract class JustTheTooltipState<T> extends State<JustTheInterface>
  ...
  Widget _createEntry() {
    ...
    final defaultShadow = Shadow(
      offset: Offset.zero,
      blurRadius: 12.0,
      color: ColorUtils.gray.shade400,
    );
