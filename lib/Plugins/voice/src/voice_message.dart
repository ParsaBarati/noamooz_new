...
import 'package:noamooz/Plugins/voice/src/contact_noise.dart';
import 'package:noamooz/Plugins/voice/src/helpers/utils.dart';
...
class _VoiceMessageState extends State<VoiceMessage>
  ...
  Container _sizerChild(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: widget.me ? ColorUtils.gray.withOpacity(0.1) : ColorUtils.orange,
        // color: !widget.me ? ColorUtils.orange : ColorUtils.gray.withOpacity(0.1),
      ),
      child: Padding(
  ...
  _playButton(BuildContext context) => InkWell(
        child: Container(
          decoration: BoxDecoration(
            ...
            color: !widget.me ? ColorUtils.gray : ColorUtils.orange,
          ),
          width: 8.w(),
          height: 8.w(),
          child: InkWell(
            ...
            child: !_audioConfigurationDone
                ...
                : Icon(
                    ...
                    color: widget.me ? ColorUtils.gray : ColorUtils.gray,
                    size: 5.w(),
                  ),
          ),
        ),
            ...
            children: [
              if (!widget.played)
                Widgets.circle(
                  context,
                  1.w(),
                  !widget.me ? ColorUtils.gray : ColorUtils.orange,
                ),
  ...
  _noise(BuildContext context) {
    ...
    final newTHeme = theme.copyWith(
      sliderTheme: SliderThemeData(
        ...
        activeTickMarkColor: ColorUtils.orange,
        activeTrackColor: ColorUtils.orange,
                ...
                builder: (context, child) {
                  return Positioned(
                    ...
                    child: Container(
                      ...
                      height: 6.w(),
                      color: !widget.me
                          ? ColorUtils.orange.withOpacity(0.4)
  ...
  //           color: ColorUtils.gray.withOpacity(.28),
  //         ),
  //         width: 9.8.w,
  //         child: Text(
  //           !x2 ? '1X' : '2X',
  //           style: TextStyle(fontSize: 9.8, color: ColorUtils.gray),
  //         ),
  //       ),
  //     );
